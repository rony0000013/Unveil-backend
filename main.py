...
prompt = f"Write a summary of the current condition of the stock in beginner friendly manner. \
The summary should be in the form of a story. It should be simple enough to be understood by naive people. \
